...
public class question1 {
	...
	public question1 (java.io.Reader reader) {
		this ();
		if (null == reader) {
	...
	public question1 (java.io.InputStream instream) {
		this ();
		if (null == instream) {
			throw (new Error("Error: Bad input stream initializer."));
		}
...
"0:10,5,0:22,3,2,3:4,0,3:4,0:2,4,0,1:10,0:6,3:27,0:3,3:2,0,3:26,0:5,6:2")[0];

	private int yy_rmap[] = unpackFromString(1,8,
"0,1,2:3,3,4,3")[0];

	private int yy_nxt[][] = unpackFromString(5,7,
"-1,1,6,-1:2,2,3,-1,1,-1:2,7,-1:10,5,-1:6,6,4,6,-1:3");
